<?php
/*
 * Template Name: Shared Content - Online and digital learning
 * 
 *
 *
		...
		<div id="primary" class="content-area clr">
			...
			<div id="content" class="site-content clr">
				...
				<?php do_action( 'ocean_before_content_inner' ); ?>
                    ...
                    <h1 class="elementor-heading-title elementor-size-large">Online and digital learning - content shared by the community</h1>
                    <hr />
                            ...
                            'post_type'      => 'share',
                                'tax_query'      => array(
                                    array(
                                        ...
                                        'field'    => 'id',
                                        'terms'    => array(320, 325, 324, 322, 323, 326, 321)
                                    ),
                                ),
                                ));
