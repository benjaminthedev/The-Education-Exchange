<?php
/*
 * Template Name: Shared Content - Connecting and expanding learning
 * 
 *
 *
		...
		<div id="primary" class="content-area clr">
			...
			<div id="content" class="site-content clr">
				...
				<?php do_action( 'ocean_before_content_inner' ); ?>
                    ...
                    <h1 class="elementor-heading-title elementor-size-large">Connecting and expanding learning - content shared by the community</h1>
                    <hr />
